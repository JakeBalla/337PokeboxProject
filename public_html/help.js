...
helpPageHTML.push('<img id="help-image"src="img/pokemon-view.png" alt="picure of the pokemon screen">\n<h1>The Pokemon Screen</h1>\n<p>Here is where the chosen pokemon from search will be displayed. Here you can see it\'s Typing, stats, abilities, and other information.\n Alongside the information about the Pokemon, there is also a table in the bottom right of the screen. This chart shows the levels for each stat according to Cypher System, a Tabletop Role Playing Game. The \'x\'s on the chart show what level the pokemon has for that stat. For instance, this Aron would have an HP of Level 2 and an Attack of Level 4.</p>\n');
